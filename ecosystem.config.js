  ...
  apps: [
    {
      ...
      watch: false,
      // [FIX-PM2-MEMORY-2026-05-26] max_memory_restart aumentado de 250M → 800M → 1500M.
      // El live trader usa ~515MB en reposo pero alcanza ~850-900MB durante inferencia
      // (FracDiff + AutoEncoder 492-dim + 3 semillas XGB/LSTM). El limite de 800M lo mataba
      // justo en el ciclo de inferencia. Nuevo limite seguro: 1500M (VPS tiene 7.7GB total).
