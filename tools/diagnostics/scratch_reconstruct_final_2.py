...
# ONLY strip exactly 4 spaces from the erroneously indented block (2103 to 2158)
for i in range(2103, 2159):
    l = lines_orig[i]
...
# Keep the rest of the file EXACTLY intact (2159 to end)
for i in range(2159, len(lines_orig)):
