...
NEW_BLOCK += b"                _macro_boost = float(_cfg_macro.features.sfi_macro_stable_boost)\r\n"
NEW_BLOCK += b"                _macro_feats = set(_cfg_macro.features.sfi_macro_stable_features or [])\r\n"
