...
3. **Vuelve inmediatamente a la FASE 1.** El bucle de monitoreo debe continuar iterando ininterrumpidamente hasta que la run reporte su finalización definitiva (100% completado todas las 29 semillas). revisa de cerca la implementacion de los ultimos fixes