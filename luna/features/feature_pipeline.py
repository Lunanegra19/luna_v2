...
Pipeline que transforma los datos raw (8 categorÃƒÂ­as) en features listas para el modelo.

ORDEN OBLIGATORIO de transformaciones (no alterar el orden):
1. Carga de las 8 categorÃƒÂ­as raw
2. Safety Lags por categorÃƒÂ­a (tabla TE validada Ã¢â‚¬â€ R1)
3. Merge en ÃƒÂ­ndice 1H UTC (join por timestamp exacto)
...
8. FracDiff dinÃƒÂ¡mico por ventana (R7)
9. alpha_rules.py import Ã¢â€ â€™ columnas binarias
10. Target dinÃƒÂ¡mico future_ret_24h (R17)
11. SFI Filter (RF OOB > 0.05 Sharpe)
12. Clustering de correlaciÃƒÂ³n (threshold 0.70)
13. Split Train/Val/Holdout Ã¢â€ â€™ guardar parquets

Reglas crÃƒÂ­ticas:
- R1:  Safety lags ANTES del merge
- R7:  FracDiff dinÃƒÂ¡mico por ventana
- R13: alpha_rules.py nativo Ã¢â‚¬â€ NUNCA JSON bridge
- R14: Rolling Z-Score 90d obligatorio
- R17: Target dinÃƒÂ¡mico Ã¢â‚¬â€ NUNCA features_labeled.parquet estÃƒÂ¡tico de V8.3
"""
...
from luna.data.btc_supply                import BTCDynamicSupply       # BUG M-03: supply dinÃƒÂ¡mico con halvings
...
class FeaturePipeline:
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ PASO 1+2+3: Carga + Safety Lags + Merge Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

    def load_and_merge_raw(self) -> pd.DataFrame:
        """
        Carga las 8 categorÃƒÂ­as raw, aplica safety lags y hace merge en 1H UTC.

        Safety Lags (tabla validada por Transfer Entropy):
        - Macro (M2):            shift +42d  (R1 Ã¢â‚¬â€ correlaciÃƒÂ³n BTC-M2 documentada)
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Base: OHLCV 1H Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        base = raw.get("ohlcv_1h", pd.DataFrame())
        if base.empty:
            raise ValueError("OHLCV 1H no disponible. Ejecutar DataCollector.fetch_all primero.")

        # ðŸ”¸ Futures (Perps) â€” sin lag ðŸ”¸
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Macro Ã¢â‚¬â€ resamplear a 1H + safety lags Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ On-chain Ã¢â‚¬â€ lag +24H Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Derivatives Ã¢â‚¬â€ sin lag Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Altcoins Ã¢â‚¬â€ ETH lag +13d, resto sin lag Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        if "altcoins" in raw and not raw["altcoins"].empty:
            ...
            # ETH lag (con validaciÃ³n dinÃ¡mica C8)
            ...
            if eth_cols and "ETH_Price" in alt.columns and "close" in base.columns:
                try:
                    ...
                    logger.warning(f"No se pudo validar ETH Lag dinÃ¡mico (C8): {e}")

            if eth_cols:
                alt[eth_cols] = alt[eth_cols].shift(cfg.data.eth_lag_days * 24)
            base = base.join(alt, how="left", rsuffix="_alt")

        # Ã¢â€â‚¬Ã¢â€â‚¬ DeFi Ã¢â‚¬â€ lag +24H Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Mempool Ã¢â‚¬â€ sin lag Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ ETF Ã¢â‚¬â€ sin lag Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Stablecoin_Cap + M2 Global Ã¢â‚¬â€ lag +24H Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        if "stablecoin_m2" in raw and not raw["stablecoin_m2"].empty:
            ...
            stab = stab.shift(cfg.data.onchain_lag_hours)  # +24H (publicaciÃƒÂ³n externa)
            # Calcular SSR Z-Score aquÃƒÂ­ ya tenemos close disponible
            ...
            # Renombrar columnas que colisionarÃƒÂ¡n con macro para evitar _stab suffix
            # Columnas de stablecoin_m2 que NO existen en base Ã¢â€ â€™ sin problema
            # Columnas que SÃƒÂ existen (Stablecoin_Cap se crea vacÃƒÂ­a del macro join) Ã¢â€ â€™ forzar overwrite
            ...
            # AÃ±adir las columnas Ãºnicas de stablecoin (sin rsuffix)
            if stab_only_cols:
                stab_mapped_only = stab[stab_only_cols].reindex(base.index, method='ffill')
                base = base.join(stab_mapped_only, how="left")

        # â”€â”€ M2 Global Composite (Fase 4) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        if m2_global_path.exists():
            try:
                ...
                # El lag estructural de 42 dÃ­as ya estÃ¡ aplicado en el fetcher.
                base = base.join(m2_global, how="left")
                logger.info("M2 Global Composite (YoY) integrado con Ã©xito.")
            except Exception as e:
                logger.warning(f"Error cargando m2_global.parquet: {e}")

        # SSR Z-Score (Stablecoin Supply Ratio) Ã¢â‚¬â€ requiere close + Stablecoin_Cap
        if "Stablecoin_Cap" in base.columns and "close" in base.columns:
            # Fix BUG M-03: supply dinÃ¡mico por halvings (evita error ~9% con 19.8M fijo)
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Deduplicar columnas tÃƒÂ©cnicas _mem / _etf Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        for suffix in ["_mem", "_etf", "_onchain", "_defi"]:
            ...
            for sc in suffixed_cols:
                ...
                if original in base.columns:
                    # Elegir la que tenga menos NaN (= mÃƒÂ¡s datos)
                    nan_orig    = base[original].isna().mean()
                    nan_suffixed = base[sc].isna().mean()
                    if nan_suffixed <= nan_orig:
                        # La versiÃƒÂ³n _mem tiene igual o menos NaN Ã¢â€ â€™ reemplazar
                        base[original] = base[original].fillna(base[sc])
                    # Eliminar la columna tÃƒÂ©cnica con sufijo siempre
                    base = base.drop(columns=[sc])
                    logger.debug(f"Dedup {sc} -> {original} (NaN: {nan_orig:.1%} Ã¢â€ â€™ {base[original].isna().mean():.1%})")
                else:
        ...
        # â”€â”€ DEAD-FEAT-PRUNE (2026-04-19) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        # Grupo 1: features 100% NaN que nunca fueron seleccionadas por SFI
        # (verificado en 120 logs histÃ³ricos). Eliminadas aquÃ­ para:
        #   a) Reducir raw features de ~316 â†’ ~295 (k_auto: 214 â†’ ~40)
        #   b) Evitar lag cache invalidation (SFI tarda +90 min extra sin cache)
        #   c) Eliminar columnas completamente vacÃ­as que saturan el clustering
        #
        # Grupo 3: duplicados internos â€” la informaciÃ³n ya estÃ¡ disponible en
        # columnas calculadas por apply_derived_features() con mejor calidad.
        _COLS_TO_PRUNE = [
            # â”€â”€ Grupo 1A: ETF APIs muertas (100% NaN, nunca seleccionadas) â”€â”€
            "BITO_Price",      # duplicado inferior de BITO_Close (que sÃ­ tiene datos)
            "FBTC_Price",      # API FBTC no actualizada; GBTC_Discount_Pct cubre ETF
            "ARKB_Price",      # ARK Bitcoin ETF â€” API inactiva
            "ARKB_Volume",     # ARK Bitcoin ETF â€” API inactiva
            "BITB_Price",      # Bitwise ETF â€” API inactiva
            "BITB_Volume",     # Bitwise ETF â€” API inactiva

            # â”€â”€ Grupo 1B: Macro APIs muertas (100% NaN, nunca seleccionadas) â”€â”€
            "Breakeven_Inflation_5Y",  # FRED T5YIE â€” sÃ©rie descontinuada en raw;
                                       # CPI_YoY (31% NaN) cubre expectativas de inflaciÃ³n
            "NatGas",          # Gas Natural â€” sin actualizaciÃ³n; Oil (sano) cubre energÃ­a
            "USD",             # Ã­ndice USD crudo â€” DXY es el estÃ¡ndar y estÃ¡ disponible

            # â”€â”€ Grupo 1C: Mempool APIs muertas (100% NaN, nunca seleccionadas) â”€â”€
            "avgFees",         # mempool_raw â€” API completamente inactiva
            "avgHeight",       # mempool_raw â€” API completamente inactiva

            # â”€â”€ Grupo 1D: Derivatives legacy (100% NaN, nunca seleccionadas) â”€â”€
            "ls_ratio_ema_24h",  # EMA del LongShortRatio â€” derivado de LSR que
                                 # tambiÃ©n estÃ¡ deteriorado; LongAccount lo reemplaza

            # â”€â”€ Grupo 3: Duplicados internos exactos â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # Mantener ambas duplica la informaciÃ³n y crea features correlacionadas 1.0.
            "BTC_SP500_Ratio",

            # BTC_Gold_Ratio: 100% NaN y sin alternativa directa calculable.
            # El pipeline no tiene fuente de Gold en raw (Gold_Ret tambiÃ©n 100% NaN).
            "BTC_Gold_Ratio",
        ]
        ...
        if pruned:
            ...
            logger.info(
                f"DEAD-FEAT-PRUNE: eliminadas {len(pruned)} columnas vacÃ­as/duplicadas "
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ PASO 3B: Mining Outputs (K_Shape_Cluster_ID + Master_Causal_Signal) Ã¢â€â‚¬Ã¢â€â‚¬

    def _check_parquet_freshness(self, path: "Path", max_days: int = 7) -> bool:
        """Fix F20: Verifica que el parquet no supere max_days de antigÃƒÂ¼edad."""
        if not path.exists():
            return False
        ...
        if age_days > max_days:
            logger.warning(
                f"[F20 Stale-Check] {path.name} tiene {age_days} dÃƒÂ­as de antigÃƒÂ¼edad "
                f"(mÃƒÂ¡x: {max_days}d). SeÃƒÂ±al posiblemente obsoleta. "
    ...
    def integrate_mining_outputs(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        del pipeline. Este mÃƒÂ©todo une ambos.

        Si los parquets enriquecidos no existen (primer run), genera versiones
        simplificadas inline para no bloquear el pipeline.

        Ejecutar run_weekly_mining.py primero para obtener la versiÃƒÂ³n precisa.
        """
        # â”€â”€ Master_Causal_Signal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        if "Master_Causal_Signal" not in df.columns:
            bce_weights_path = _ROOT / "data" / "models" / "bce_weights.json"
            _mcs_calculated = False
            
            # [P2-BCE-SERIALIZATION] Inferencia Online DinÃ¡mica
        ...
        if "KMeans_Tribe_ID" not in df.columns:
            ...
            if tribe_parquet.exists():
                ...
                if src is not None and "KMeans_Tribe_ID" in src.columns:
                    ...
                    # â”€â”€ [A1: KMeans Online Inference] â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                    # PROBLEMA: el join + ffill() propaga el Ãºltimo cluster del training
                    # indefinidamente al holdout. Si el gap trainâ†’holdout es grande (ej:
                    # 1488h en WFB W1), el 100% del holdout queda en un solo cluster.
                    #
                    # SOLUCIÃ“N: si existe el pkl del modelo KMeans (guardado por
                    # ClusterPatternEngine con centroides ajustados SOLO en train), cargar
                    # ese modelo y predecir el cluster de cada barra OOS.
                    #
                    # GARANTÃA CAUSAL: los centroides son parÃ¡metros fijos del training.
                    ...
                    if _km_pkl.exists() and _sc_pkl.exists():
                        try:
                            ...
                            if _n_oos > 0:
                                ...
                                if len(_avail_tf) >= 3:   # mÃ­nimo razonable de features
                                    ...
                                    print(f"[LUNA][A1/KMeans] OK - {_n_oos} barras OOS reclasificadas "
                                          f"con centroides congelados. DistribuciÃ³n: {_tribe_dist}")
                                    logger.info(
                                        f"[A1/KMeans-Online] {_n_oos} barras OOS reclasificadas "
                                        f"con centroides congelados del training. "
                                        f"DistribuciÃ³n tribus OOS: {_tribe_dist}"
                                    )
                                else:
                                    ...
                                    logger.warning(
                                        ...
                                        f"TRIBE_FEATURES disponibles â€” usando ffill como fallback."
                                    )
                            else:
                            ...
                            logger.warning(f"[A1/KMeans-Online] Error en inferencia online: {_km_e} â€” usando ffill.")

                    if not _km_used_online:
                        # Fallback: ffill clÃ¡sico (degradado pero sin look-ahead si src <= train_end)
                        df["KMeans_Tribe_ID"] = df["KMeans_Tribe_ID"].ffill().fillna(0)
                        print(f"[LUNA][A1/KMeans] FALLBACK ffill activo (pkl no disponible). "
                              f"Ãšnico valor propagado: {df['KMeans_Tribe_ID'].value_counts().idxmax()}")
                    ...
                    print(f"[LUNA][A1/KMeans] FINAL: {_n_unique_tribes} tribus activas | "
                          f"distribuciÃ³n={_vc} | online_inference={_km_used_online}")
                    logger.info(f"KMeans_Tribe_ID integrado | tribus totales: {df['KMeans_Tribe_ID'].nunique()} | online_inference={_km_used_online}")
                    # â”€â”€ fin [A1] â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€


            else:
                logger.warning("NingÃºn parquet con KMeans_Tribe_ID. KMeans fallback inline.")
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Features derivadas requeridas por selected_features.json Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        # M2_YoY_Chg_milag12h: M2_YoY_Chg con lag extra de 12H (mitigaciÃƒÂ³n de retraso de publicaciÃƒÂ³n)
        ...
        # â”€â”€ HMM_Regime + HMM_Semantic (Fase 2: AsimetrÃ­a Causal) â”€â”€â”€â”€â”€â”€â”€â”€â”€
        # [FIX-PIPE-001] Inyectar HMM_Regime Y HMM_Semantic ANTES de SFI para selecciÃ³n
        # causal condicionada. CRÃTICO: HMM_Semantic (string) es requerida por el filtro
        # isin(hmm_allowed_regimes) en predict_oos.py. Sin ella, el filtro rechaza TODAS
        # las seÃ±ales y el WFB produce 0 trades. Bug raÃ­z: join solo incluÃ­a HMM_Regime.
        ...
        if "HMM_Regime" not in df.columns:
            if hmm_parquet.exists():
                try:
                    ...
                    if "HMM_Regime" in hmm_src.columns:
                        # [FIX-PIPE-001] Incluir HMM_Semantic si estÃ¡ disponible en el parquet.
                ...
                logger.warning(
                    ...
                    f"SFI evaluarÃ¡ sin rÃ©gimen (Global)."
                )
                print(f"[FIX-PIPE-001][WARN] hmm_regime_labels.parquet no existe todavÃ­a (normal en 1Âª pasada del pipeline).")

        elif "HMM_Semantic" not in df.columns:
            # [FIX-PIPE-001-B] Guard secundario: HMM_Regime ya estÃ¡ en df (de una pasada anterior del pipeline)
            # pero HMM_Semantic no. Esto ocurre cuando el pipeline se ejecutÃ³ antes de este fix.
            ...
            if not _semantic_injected:
                logger.warning(
                    "[FIX-PIPE-001-B] No se pudo inyectar HMM_Semantic por ningÃºn mÃ©todo. "
                    "El filtro de rÃ©gimen en predict_oos producirÃ¡ 0 seÃ±ales."
                )
                print("[FIX-PIPE-001-B][WARN] HMM_Semantic no disponible. 0 trades probable en esta ventana.")

        return df

    # Ã¢â€â‚¬Ã¢â€â‚¬ PASO 4: Rolling Z-Score (R14) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    def apply_rolling_normalization(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        [V2-P4] Las features '_kz' se aÃ±aden ADICIONALMENTE al rolling 90d original.
        El SFI decidirÃ¡ cuÃ¡les son mÃ¡s predictivas en cada ventana WFB.

        Rolling Z-Score 90d: ventana fija, estable, retrocompatible (R14).
        Kalman Z-Score (_kz): adaptativo, detecta cambios de rÃ©gimen en ~14-21d.
        """
        # â”€â”€ Paso 1: Rolling Z-Score 90d (comportamiento original â€” R14) â”€â”€
        df = self.normalizer.transform(df, columns=MACRO_COLUMNS)

        # â”€â”€ Paso 2: Kalman Z-Score adaptativo (V2-P4) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        try:
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ PASO 5: MultiTimeframe features Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    def apply_multitimeframe_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            logger.warning("multitimeframe_features.py no disponible aÃƒÂºn. Saltando.")
        return df

    # Ã¢â€â‚¬Ã¢â€â‚¬ PASO 6: Calendar Features Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ PASO 7: Cross-Asset features Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    def apply_crossasset_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # AquÃƒÂ­ aseguramos que estÃƒÂ¡ presente
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ PASO 7B: Derived Macro + On-Chain features (mc_* / oc_*) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    def apply_derived_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        No requiere fetchers adicionales Ã¢â‚¬â€ usa VIX, DXY, SP500, close, volume,
        YieldCurve_10Y3M, M2_YoY_Chg, Hashrate, etc. ya presentes en df.
        """
        import numpy as np

        # Ã¢â€â‚¬Ã¢â€â‚¬ Macro Market (mc_*) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ On-Chain proxies (oc_*) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

        # Hashrate derived Ã¢â‚¬â€ ya tenemos Hashrate_TH_s y Hashrate_7d_MA en onchain_raw
        ...
        # Active Addresses Ã¢â‚¬â€ varios posibles nombres de columna desde onchain_raw
        aa_series = None
        ...
        if "close" in df.columns:
            # Fallback a volumen de exchange (7d MA) si ActiveAddresses estÃƒÂ¡ corrupto (< 10% datos)
        ...
        # Exchange Flow Proxy Ã¢â‚¬â€ OBV momentum desde OHLCV (calculable siempre)
        if "close" in df.columns and "volume" in df.columns:
            ...
            # FIX: OBV_Momentum del bridge histÃƒÂ³rico tiene 100% NaN (columna no en daemon parquet).
            # Rellenar con oc_obv_momentum calculado aquÃƒÂ­ (mismo concepto, datos completos).
        ...
        # STH-SOPR proxy â€” precio actual / media rolling 90d
        if "close" in df.columns:
            close_s = df["close"]
        ...
        # â”€â”€ [H4-ATH 2026-06-03] ATH Regime Features â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # SFI decidira si tienen DSR > 0 en IS. Sin hardcodes â€” todo desde close.
        if "close" in df.columns:
        ...
        # â”€â”€ Derivatives (dv_*) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        if "FundingRate_EMA3" not in df.columns:
            ...
            # Prioridad 2: derivar desde FundingRate o dv_funding_rate (siempre disponibles)
                ...
                if _fr_src is not None:
                    # span=24 en 1H â‰¡ span=3 en 8H (definiciÃ³n original del fetcher)
        ...
        if _skew_fr_fixed > 0:
            print(f"[FIX-SKEW-01] {_skew_fr_fixed} alias/derivadas aplicadas. FundingRate_EMA3={'âœ…' if 'FundingRate_EMA3' in df.columns else 'âŒ'} | FundingRate_Pct90d={'âœ…' if 'FundingRate_Pct90d' in df.columns else 'âŒ'}")


        # LongShortRatio histÃƒÂ³rico Ã¢â‚¬â€ Coinglass CSV como fuente primaria 2023+
        # Binance Futures L/S solo disponible desde 2025Ã¢â€ â€™ no cubre training (2020-2024)
        # Coinglass CSV cubre 2023-05-04Ã¢â€ â€™2026-02 (1000 filas diarias)
        ...
        # LongAccount/ShortAccount â€” derivar desde LongShortRatio
        # LSR = LongAccount / ShortAccount, LongAccount + ShortAccount = 1
        # â†’ LongAccount = LSR / (1 + LSR), ShortAccount = 1 / (1 + LSR)
        for lsr_col in ["LongShortRatio", "ls_ratio"]:
            if lsr_col in df.columns:
                ...
                if nan_la > 0.5:
                    # [P2-3-FIX] ValidaciÃ³n de anomalÃ­as en Coinglass (ej. si el csv trae % long en lugar de ratio)
                    if lsr.max() > 5.0:
                    ...
                    # Coinglass ratios como alias del mismo cÃ¡lculo (para backward compat)
        ...
        # ETF Flow proxy (ya existe como ETF_Flow_Proxy, aÃ±adimos dv_ alias)
        ...
        # â”€â”€ DVOL derived (Volatilidad ImplÃ­cita Deribit) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Micro-Structure (ms_*) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            if "Futures_Volume" in df.columns and "Futures_Taker_Buy" in df.columns:
                ...
                if _cvd_nan_pct > 0.90:
                    logger.warning(
                        ...
                        f"XGBoost manejara NaN internamente pero la seÃ±al CVD se pierde."
                    )
                else:
                ...
                logger.warning(
                    ...
                    "ausentes del DataFrame. Verificar que el fetcher de derivados estÃ¡ activo y el "
                    "endpoint de Binance Futures (GET /fapi/v1/trades) estÃ¡ funcionando."
                )
                logger.info("Micro-Structure features (ms_*) generadas: Taker Ratios desde crudo L1")

        # â”€â”€ Timing Short-term Features (timing_*) â”€â”€
        ...
        # â”€â”€ Momentum multi-TF (mt_*) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        if "close" in df.columns:
            close_s = df["close"]
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Calendar extras (cal_*) Ã¢â‚¬â€ completar gap vs Luna v2 Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        # SeÃƒÂ±ales de periodicidad semanal/mensual documentadas
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ MI-Lag Features (lags optimos descubiertos por Feature Selection) Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ P4-1-1: 5 Features de DetecciÃƒÂ³n de RÃƒÂ©gimen Actual Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        # DiagnÃƒÂ³stico Run9: el modelo no detectaba el cambio de rÃƒÂ©gimen 2025.
        # Estas features capturan el CONTEXTO DE MERCADO ACTUAL (no solo histÃƒÂ³rico).
        if "close" in df.columns:
            close_r = df["close"].ffill()

            # 1. btc_trend_regime: ratio EMA50H / EMA200H Ã¢â‚¬â€ tendencia estructural
            ...
            #    0 = vol en mÃƒÂ­nimos histÃƒÂ³ricos (calm), 1 = vol en mÃƒÂ¡ximos (crisis)
            ewm_vol = close_r.pct_change().ewm(span=24, adjust=False).std()
            df["vol_percentile_90d"] = ewm_vol.rolling(90 * 24).rank(pct=True)

            # 3. realized_vol_ratio: vol_7d / vol_30d Ã¢â‚¬â€ aceleraciÃƒÂ³n de volatilidad
            #    >1 = volatilidad subiendo (incertidumbre), <1 = calmÃƒÂ¡ndose
            ...
            #    0 = en mÃƒÂ¡ximos recientes, -0.30 = 30% por debajo del ATH de 90d
            ...
            #    0.0 = mÃƒÂ­nimo anual (bottom de ciclo), 1.0 = mÃƒÂ¡ximo anual (techo de ciclo)
            #    Captura la posiciÃƒÂ³n en el ciclo BTC Ã¢â‚¬â€ ÃƒÂºtil para discriminar bull-trend real
            #    de rally dentro de bajista. Se persiste aquÃƒÂ­ para que OOS generator la tenga.
        ...
        # 5. funding_regime: Percentil 30d del funding rate Ã¢â‚¬â€ sesgo del mercado retail
            ...
            for col in hmm_z_cols:
                if col in df.columns:
                    ...
                    if z_col not in df.columns:
                        ...
                        logger.info(f"[HMM-FIX-ZSCORE-OOS] TransformaciÃ³n {z_col} inyectada globalmente.")
        except Exception as _e_hmmz:
            logger.warning(f"[HMM-FIX-ZSCORE-OOS] Error inyectando variables z90d globalmente: {_e_hmmz}")

        # â”€â”€ [P2] HMM Transition Velocity (2026-04-09) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        # Derivada suavizada de la probabilidad HMM del rÃ©gimen BULL.
        # Convierte el vector de probabilidades del HMM (normalmente sÃ³lo categÃ³rico)
        # en una seÃ±al continua que captura la VELOCIDAD DE ROTACIÃ“N de rÃ©gimen.
        # Key insight: cuando P(BULL) cae rÃ¡pidamente (velocidad<0), el modelo debe
        # ser mÃ¡s conservador aunque el HMM aÃºn no haya cambiado de etiqueta.
        #
        ...
        # - El diff() opera sÃ³lo sobre el pasado causal en cada timestep
            ...
            if _hmm_pkl.exists():
                ...
                if _hmm_model is not None and _hmm_scaler is not None and _hmm_features is not None:
                    ...
                    if len(_hmm_feats_avail) == len(_hmm_features):  # requiere todas las features del modelo
                        ...
                        # Identificar el Ã­ndice del estado BULL (1_BULL_TREND o similar)
                        ...
                        if _bull_state_idx is not None and _bull_state_idx < _proba.shape[1]:
                            ...
                            # AceleraciÃ³n (segunda derivada suavizada) para capturar inflexiones
                ...
                logger.debug("[P2] HMM Velocity: hmm_regime.pkl no encontrado â€” feature omitida (normal en primer run)")
        except Exception as _e_p2:
            logger.warning(f"[P2] HMM Velocity fallÃ³ silenciosamente (no crÃ­tico): {_e_p2}")

        # â”€â”€ [P4] Macro-OHL Tension Index (2026-04-09) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        # Ãndice compuesto que articula la divergencia entre seÃ±al tÃ©cnica (precio alcista)
        # y fundamentales (liquidez fiat, valoraciÃ³n on-chain, dÃ³lar fuerte).
        #
        # FÃ³rmula: macro_ohl_tension = NVT_z Ã— |M2_trend| Ã— sign(-DXY_slope)
        # Truncado a [-5, 5] para evitar outliers en periodos de crisis extrema.
        # Alta tensiÃ³n (>1Ïƒ): divergencia tÃ©cnica/fundamental â†’ XGBoost penaliza entradas Long.
        # Baja tensiÃ³n (<0): confluencia macro + tÃ©cnica â†’ mÃ¡xima convicciÃ³n.
        #
        # Robustez: todos los componentes pasan por z-score rolling 90d antes de combinarse,
        # lo que hace el Ã­ndice invariante ante cambios de escala absoluta entre ciclos BTC.
        try:
            _tension_components_available = []

            # Componente 1: NVT proxy (sobrevaloraciÃ³n on-chain relativa)
            ...
            # Componente 2: M2 trend magnitude (retiro/inyecciÃ³n de liquidez fiat)
            # Usar M2_MoM_Chg_z90d_milag120h si estÃ¡ disponible (ya tiene safety lag correcto)
            _m2_series = None
            ...
            # Componente 3: DXY slope (dÃ³lar fuerte = negativo para crypto)
            # sign(-DXY_slope) > 0 cuando el dÃ³lar se debilita (favorable crypto)
            _dxy_series = None
            if "DXY_Ret" in df.columns:
                _dxy_slope = df["DXY_Ret"].ewm(span=96, adjust=False).mean()  # EWM 4 dÃ­as
            ...
            if len(_tension_components_available) >= 2:
                # Construir el Ã­ndice con los componentes disponibles
                ...
                # Z-score final rolling 90d para estandarizar la magnitud del Ã­ndice compuesto
                ...
                logger.warning(
                    ...
                    f"(mÃ­n 2). Feature omitida. Verificar NVT/M2/DXY en los datos raw."
                )
        except Exception as _e_p4:
            logger.warning(f"[P4] Macro-OHL Tension fallÃ³ silenciosamente (no crÃ­tico): {_e_p4}")

        # â”€â”€ [DXY-HMM-01 2026-06-03] DXY Condicional al RÃ©gimen HMM â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        # MOTIVACIÃ“N: El DXY tiene ambigÃ¼edad de signo segÃºn el rÃ©gimen de mercado.
        # - Bull/Risk-On (HMM alto): DXYâ†‘ â†’ BTCâ†“ (correlaciÃ³n negativa clara)
        # - Bear/Risk-Off (HMM bajo): la correlaciÃ³n se debilita o invierte
        #   (deleveraging forzado, todos los activos caen juntos)
        # XGBoost no puede modelar esta interacciÃ³n sin features de Ã¡rbol muy profundos.
        # La feature condicional pre-calcula la seÃ±al ajustada al rÃ©gimen.
        #
        # CAUSALIDAD: HMM_Regime usa Forward Algorithm (no Viterbi) â€” sin look-ahead (R1).
        # Disponible desde integrate_mining_outputs (Paso 3B) â€” antes de este paso (7B).
        #
        # FEATURES GENERADAS:
        # - DXY_HMM_cond:     DXY_Ret Ã— regime_sign  â†’ positivo cuando DXY es bearish para BTC
        # - DXY_HMM_interact: DXY_Zscore Ã— HMM_Regime â†’ interacciÃ³n suave para Ã¡rboles
        # - DXY_HMM_bull_neg: DXY_Ret Ã— bull_flag Ã— (-1) â†’ seÃ±al pura en rÃ©gimen bull
        try:
            ...
            if _has_dxy_ret and _has_hmm:
                ...
                # Normalizar rÃ©gimen a [-1, +1]: 0=crash(bear) â†’ -1, 4=bull â†’ +1
                _regime_norm = (_hmm_reg / (_n_states_dxh - 1)) * 2 - 1  # [-1, +1]

                # Feature 1: SeÃ±al condicional â€” DXY amplificado por rÃ©gimen
                # En bull (+1): DXY_Ret puro (correlaciÃ³n negativa con BTC activa)
                # En crash (-1): DXY_Ret invertido (correlaciÃ³n menos confiable)
                df["DXY_HMM_cond"] = _dxy_ret * (-_regime_norm)
                # InterpretaciÃ³n: positivo â†’ condiciÃ³n bearish para BTC (DXY sube en bull)
                #                 negativo â†’ condiciÃ³n bullish para BTC

                # Feature 2: Bull-flag binario Ã— DXY â€” mÃ¡s interpretable para el Ã¡rbol
                _bull_flag = (_hmm_reg >= _n_states_dxh // 2).astype(float)  # 1 en estados >= 2
                df["DXY_HMM_bull_neg"] = _dxy_ret * _bull_flag * (-1.0)
                # En rÃ©gimen bull: -DXY_Ret (cae cuando DXY sube â†’ seÃ±al bearish)
                # En rÃ©gimen bear: 0 (no hay seÃ±al confiable)

                # Feature 3: InteracciÃ³n suave (continua) para gradiente mÃ¡s suave
                if _has_dxy_z:
        ...
        # â”€â”€ Fin [DXY-HMM-01] â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ PASO 8: FracDiff dinÃƒÂ¡mico (R7) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

    def apply_fracdiff_dynamic(self, df: pd.DataFrame,
                                train_cutoff: str | None = None) -> pd.DataFrame:
        """
        FracDiff dinÃƒÂ¡mico: d se recalcula por ventana via ADF test.
        R7: NUNCA d_val=0.4 fijo.

        Fix C-03: el ADF (que determina d) se ejecuta SOLO sobre el training set
        (train_cutoff). El d ÃƒÂ³ptimo encontrado en train se aplica luego al dataset
        completo via transform. AsÃƒÂ­ evitamos que los datos futuros influyan en el
        parÃƒÂ¡metro de diferenciaciÃƒÂ³n selÃƒÂ©ccionado.

        BUG-1 FIX (P4-0-1, 2026-03-08): train_cutoff se lee de settings.yaml en lugar
        de estar hardcodeado a '2023_12_31'. Con train_end=2024-06-30, el d ÃƒÂ³ptimo
        ahora se calcula sobre el training set extendido completo.
        """
        # Leer train_cutoff de settings si no se pasa explÃƒÂ­citamente
        if train_cutoff is None:
            try:
                from config.settings import cfg
                train_cutoff = cfg.temporal_splits.train_end
                logger.info(f"FracDiff train_cutoff leÃƒÂ­do de settings.yaml: {train_cutoff}")
            except Exception:
                raise RuntimeError("FracDiff: no se pudo leer settings.yaml.temporal_splits.train_end Ã¢â‚¬â€ requerido para evitar look-ahead en FracDiff (C-03)")

        try:
            from luna.features.fracdiff_dynamic import FracDiffDynamic
            fd = FracDiffDynamic()

            # Fix C-03: detectar los ÃƒÂ­ndices del training set para la bÃƒÂºsqueda de d
            ...
            if len(df_train) < 100:
                logger.warning("C-03: df_train insuficiente para ADF Ã¢â‚¬â€ usando todo el df para FracDiff (fallback)")
                ...
                # 1) Encontrar d ÃƒÂ³ptimo sobre el training set (causal)
                for col in ["close", "volume"]:
                    ...
                    logger.info(f"FracDiff C-03 [{col}]: d_opt={d_opt:.3f} (calculado sobre train Ã¢â€°Â¤ {train_cutoff})")
                ...
                for col in ["close", "volume"]:
                    ...
                    df[f"{col}_fd"] = fd_col
                    logger.info(f"FracDiff [{col}]: d={d_opt:.3f} Ã¢â€ â€™ {col}_fd (log-transformed)")

        except ImportError:
            logger.warning("fracdiff_dynamic.py no disponible aÃƒÂºn. Saltando FracDiff.")
        return df

    # Ã¢â€â‚¬Ã¢â€â‚¬ PASO 9: Alpha Rules (R13 Ã¢â‚¬â€ NATIVO, sin JSON bridge) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    def apply_alpha_rules(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        if not alpha_path.exists():
            logger.warning("alpha_rules.py no existe aÃƒÂºn. Ejecutar AI Mining primero (run_weekly_mining.py).")
            return df
        ...
        try:
            ...
            # P3-N1-FIX (2026-03-30): CachÃ© del mÃ³dulo importado dinÃ¡micamente.
            # Evita re-ejecuciÃ³n si el pipeline se corre mÃºltiples veces en el mismo proceso (tests).
            ...
            # get_alpha_features es la funciÃ³n principal (genera las 5 alpha signals)
            if hasattr(mod, "get_alpha_features"):
                df = mod.get_alpha_features(df)
            else:
                # Fallback por compatibilidad con versiones anteriores del mÃ³dulo
            ...
            print(f"[LUNA][A4/DeepDiscovery] OK - MÃ³dulo dinÃ¡mico alpha_rules.py cargado exitosamente. "
                  f"GenerÃ³ {len(alpha_cols)} seÃ±ales alpha para esta ventana.")
            logger.info(f"[A4/DeepDiscovery] Alpha Rules: {len(alpha_cols)} seÃ±ales alpha dinÃ¡micas integradas -> {alpha_cols}")
            ...
            try:
                ...
                if not _use_dtw and 'alpha_dtw_signal' in df.columns:
                    ...
                    print(f"[LUNA][DTW-DISABLE-01] alpha_dtw_signal ZEROEADO "
                          f"(use_dtw_signal=false) â€” {_n_nonzero} valores anulados. "
                    ...
                    logger.warning(f"[DTW-DISABLE-01] alpha_dtw_signal desactivado por settings. "
                                   f"El trigger DTW no dispararÃ¡ en esta ventana.")
                elif _use_dtw:
                ...
                print(f"[LUNA][DTW-DISABLE-01] No se pudo leer use_dtw_signal de settings: {_e_dtw} â€” DTW activo por defecto")
    ...
    # â”€â”€â”€â”€ PASO 10: Limpieza Pre-Split (R17) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    def add_tbm_target(self, df: pd.DataFrame) -> pd.DataFrame:
        """
        [FIX-SFI-TBM-01] Single Source of Truth para etiquetado.
        Genera Target_TBM_Bin usando parÃ¡metros globales estÃ¡ndar para que el SFI
        evalÃºe las caracterÃ­sticas contra las mismas reglas TBM que XGBoost usarÃ¡ despuÃ©s.
        Elimina la regresiÃ³n naive de 24H que causaba el Dual-Labeling Trap.
        """
        if "close" not in df.columns:
            logger.warning("No se puede generar TBM Target: falta 'close'")
            return df
            
        logger.info("[FP] Generando Target DinÃ¡mico TBM Centralizado (Target_TBM_Bin)...")
        from luna.features.tbm import apply_triple_barrier
        from config.settings import cfg
        
        # ParÃ¡metros Base para SFI
        _pt = 1.5
        _sl = 1.5
        ...
        if "bin" in tbm_result.columns:
            ...
            # Conservamos los NaN (operaciones sin resoluciÃ³n o gaps)
            ...
            logger.info(f"[FP] Target_TBM_Bin generado exitosamente. WinRate global estÃ¡tico: {df['Target_TBM_Bin'].mean():.1%}")
        else:
            logger.warning("[FP] Error: 'bin' no encontrado en el resultado TBM.")
            
        return df

    # Ã¢â€â‚¬Ã¢â€â‚¬ PASO 13: Split y guardado Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    def split_and_save(self, df: pd.DataFrame) -> dict[str, pd.DataFrame]:
        ...
        # ventanas futuras al modelo en inferencia. Si no estÃ¡ configurado â†’ sin lÃ­mite.
        _holdout_end_raw = getattr(splits, 'holdout_end', None)
        if _holdout_end_raw:
            holdout_end = pd.Timestamp(_holdout_end_raw, tz="UTC")
            # FIX-WFB-TBM-OOB (2026-03-29): AÃ±adimos 10 dÃ­as de colchÃ³n a la descarga de features
            # para que las barreras del TBM de los Ãºltimos trades de la ventana puedan resolverse.
            # isolate_window_trades() descartarÃ¡ luego las seÃ±ales cuya entry_time > holdout_end.
            holdout_end_extended = holdout_end + pd.Timedelta(days=10)
            holdout = df[(df.index >= holdout_start) & (df.index <= holdout_end_extended)]
            logger.info("[FIX-WFB-HOLDOUT-END-01] holdout acotado (con +10d cushion para TBM): {} â†’ {} ({} filas)",
            ...
            for _attempt in range(1, max_retries + 1):
                try:
                    ...
                    if _attempt < max_retries and getattr(_oe, "errno", None) in (13, 22):
                        ...
                        print(f"[DRIVE-RETRY] to_parquet({out_path.name}) errno={_oe.errno} â€” reintento {_attempt}/{max_retries} en {_wait}s")  # RULE[fixbugsprints.md]
        ...
        for name, data in datasets.items():
            if data.empty:
                logger.warning("[DATAFLOW-EXPORT] Split [{}] esta VACIO Ã¢â‚¬â€ revisar temporal_splits en settings.yaml", name)
                continue
            ...
            # Resumen NaN en columnas crÃ­ticas del split
        ...
        # â€”â€”â€” [DATAFLOW-EXPORT-FP-01] Cross-split consistency checks â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”â€”
        ...
        # CHECK 1: Columnas HMM en holdout â€” su ausencia causa BUG-HMM-FILTER-01
            ...
            if not holdout_df.empty:
                if _hc not in holdout_df.columns:
                    logger.warning(
                        ...
                        f"que devuelve indices numericos Ã¢â‚¬â€ asegurarse de que el fix BUG-HMM-FILTER-01 esta activo."
                    )
                else:
        ...
        # CHECK 3: No hay solapamiento de fechas entre splits (BLOQUEANTE desde LAB-02 Ã¢â‚¬â€ R4)
        if not train_df.empty and not val_df.empty:
            ...
            if _overlap_tv:
                raise RuntimeError(
                    ...
                    f"entre train y validation. El calibrador verÃƒÂ­a datos del training set. "
                    f"Revisar temporal_splits.train_end y validation_start en settings.yaml. "
                    f"(LAB-02 fix: train_end debe ser < validation_start)"
                )
            else:
                logger.info("  [DATAFLOW-EXPORT-FP-01] Solapamiento train/validation: OK (cero overlap Ã¢â‚¬â€ R4 OK)")
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ MÃƒÂ©todo maestro Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    def run(
        ...
        Args:
            skip_fracdiff: saltar FracDiff (Ãºtil en desarrollo)
            skip_sfi: saltar SFI filter (Ãºtil en prototipos rÃ¡pidos)
        ...
        logger.info("Ã°Å¸Å’â„¢ Luna V1 FeaturePipeline.run() comenzando...")
        logger.info("Ã¢â€Â" * 60)
        ...
        logger.info("[FP] Paso 1-3 (load+merge raw): {}Ãƒâ€”{} | {} Ã¢â€ â€™ {} | {:.1f}s",
        ...
        df = self.integrate_mining_outputs(df)
        logger.info("[FP] Paso 3B (mining outputs): +{} cols Ã¢â€ â€™ {} total",
                    df.shape[1] - _n_before, df.shape[1])

        # Paso 4: Rolling Z-Score (R14)
        _n_before = df.shape[1]
        df = self.apply_rolling_normalization(df)
        logger.info("[FP] Paso 4 (rolling zscore): +{} cols Ã¢â€ â€™ {} total",
                    df.shape[1] - _n_before, df.shape[1])

        # Paso 5: Multi-Timeframe
        _n_before = df.shape[1]
        df = self.apply_multitimeframe_features(df)
        logger.info("[FP] Paso 5 (multi-timeframe): +{} cols Ã¢â€ â€™ {} total",
                    df.shape[1] - _n_before, df.shape[1])

        # Paso 6: Calendar Features Ã¢â€ Â NUEVO (FOMC, Deribit, Halving, Sesiones)
        _n_before = df.shape[1]
        df = self.apply_calendar_features(df)
        logger.info("[FP] Paso 6 (calendar features): +{} cols Ã¢â€ â€™ {} total",
                    df.shape[1] - _n_before, df.shape[1])
        ...
        logger.info("[FP] Paso 7B (derived mc_/oc_/dv_): +{} cols Ã¢â€ â€™ {} total",
                    df.shape[1] - _n_before, df.shape[1])
        ...
        # primera pasada de Kalman en Paso 4 las omitÃ­a. Esta segunda pasada atrapa el resto.
        try:
            from luna.features.kalman_normalizer import KalmanZScoreNormalizer, KALMAN_COLUMNS
            from config.settings import cfg as _cfg_kz
            _kz_q = float(_cfg_kz.features.kalman_q)
        ...
        logger.info("[FP] Paso 9 (alpha rules): +{} cols Ã¢â€ â€™ {} total",
                    df.shape[1] - _n_before, df.shape[1])
        ...
        try:
            ...
            logger.warning(f"apply_tribe_features fallÃƒÂ³ (no bloquea pipeline): {e}")


        # Paso 9C: Meta-Oracle Score (Mejora M1 Ã¢â‚¬â€ 2026-03-04)
        # El Meta-OrÃƒÂ¡culo sintetiza 6 motores de Mining en un score [0,1].
        # Se lee del oracle_verdict.md (actualizado semanalmente por run_weekly_mining.py)
        # y se propaga como constante horaria Ã¢â‚¬â€ el mismo score se aplica a todas las filas
        # del dataset hasta el prÃƒÂ³ximo mining run.
        try:
            import re as _re
            ...
            if _oracle_path.exists():
                ...
                if _m:
                    ...
                    # Centrar en 0: [0,1] Ã¢â€ â€™ [-1,1] para que el SFI vea seÃƒÂ±al direccional
                    ...
                    logger.info(f"Meta-Oracle score integrado: {_oracle_score:.4f} Ã¢â€ â€™ feature={(_oracle_score-0.5)*2.0:.4f}")
                else:
                    logger.warning("meta_oracle_score: no se pudo parsear el score de oracle_verdict.md")
            else:
                logger.warning("meta_oracle_score: oracle_verdict.md no encontrado Ã¢â‚¬â€ feature omitida")
        except Exception as _e:
            logger.warning(f"meta_oracle_score fallÃ³ (no bloquea pipeline): {_e}")
        ...
        try:
            ...
            if _use_ae:
                ...
                logger.info(f"[FP] Paso 9D (AutoEncoder): ExtracciÃ³n densa completada | bottleneck={_ae_bottleneck} | {_time.monotonic() - _t_ae:.1f}s")
            else:
                logger.info("[FP] Paso 9D (AutoEncoder): OMITIDO por config")
        except Exception as e:
            import traceback
            logger.warning(f"[FP] Paso 9D (AutoEncoder) FallÃ³: {e}\n{traceback.format_exc()}")
        ...
        logger.info(f"[FP] Paso 10 (TBM Target): Etiquetado dinÃ¡mico finalizado | {_time.monotonic() - _t_tbm:.1f}s")

        # Eliminar NaN excesivos (head artifacts de lags largos)
        before = len(df)
        df = df.dropna(subset=["close"])
        logger.info("[FP] Dropna(close): {} Ã¢â€ â€™ {} filas (-{})", before, len(df), before - len(df))

        # Paso 11: PURGA anti-leakage (R1) Ã¢â‚¬â€ eliminar cualquier columna de look-ahead
        #          antes de guardar. Esto incluye future_ret_24h si por error se persistÃƒÂ­ÃƒÂ³.
        _n_before = df.shape[1]
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ NaN summary final (features con >20% NaN en el dataset completo) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        if not high_nan.empty:
            ...
            logger.info("[FP] NaN summary: ninguna columna numÃ©rica con >20%% NaN âœ…")

        logger.info("[FP] Dataset final: {} filas Ã— {} cols | tiempo total: {:.1f}s",
        ...
        # [FIX-SKEW-FINAL] Alias bridge post-dropna para garantizar nombres canÃ³nicos de entrenamiento
        ...
        # histÃ³rico completo y dropna(how='all') la elimina. Este bloque re-aplica los aliases
        # DESPUÃ‰S del dropna usando las fuentes disponibles con datos vÃ¡lidos.
        # NOTA: Solo se ejecuta si la columna canÃ³nica (train) no existe y la live sÃ­ existe.
        if live_mode:
            _FINAL_ALIAS_MAP = {
                ...
                # durante inference (no se persiste a parquet). AquÃ­ se aÃ±ade al bridge
                ...
                if _train_col not in df.columns:
                    ...
                    for _src in _live_srcs:
                        if _src in df.columns:
                            ...
                            _final_aliased.append(f"{_src}â†’{_train_col}")
                            _applied = True
                            break
                    if not _applied:
        ...
        if live_mode:
            logger.info("[FP] LIVE MODE: Saltando split_and_save â€” enviando dataset fresco a inferencia.")
            return {"live": df}
...
if __name__ == "__main__":
    ...
    import os as _os
    _parser = _ap.ArgumentParser(description="Luna V1 Ã¢â‚¬â€ Feature Pipeline")
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ Log file propio del subproceso (trazabilidad por RUN_ID) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    logger.info("Ã¢â‚¬â„¢ feature_pipeline.py __main__ Ã¢â‚¬â€ regenerando features con nuevas fechas")
    fp = FeaturePipeline()
